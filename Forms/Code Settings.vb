Public Class Code_Settings
    ...
    Private Sub ComboBox1_SelectedValueChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedValueChanged
        If ComboBox1.SelectedItem IsNot Nothing Then
            Dim selectedFSC As FileSettingsCreator2(Of CodeTemplates) = ComboBox1.SelectedItem
            PropSelectedCode = selectedFSC.GetSettings()
            PropSelectedTemplate = Nothing
    ...
    Property PropSelectedTemplate() As Template
        Get
